...
##### Take as input (as argument to Rscript) the name that lists the settings of each replication, then aggregate all replications under those settings; because method and model are the main determinants, do various investigations based on the results  



selname <- paste0("../combsel.", args)
selframe <- read.table(selname, header = FALSE, as.is = TRUE)
### columns of selection results data frames: 
### VSP TPR FPR TNR
...
### function to aggregate files with selection stats (i.e. VSP, TPR, FNR)
...
#### function to aggregate results of coefficient estimates    
#### Input: df of estimates results, and name of same 
...
#### Loop over the different 'outcomes of the 13' (in runsims.R:boot_run())
